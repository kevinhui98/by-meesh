      ...
      >
        ...
        <div className="px-3 py-4 border-t border-sidebar-border">
          ...
          <SignOutButton redirectUrl="/">
            <button className="flex items-center gap-3 px-3 py-2 w-full rounded-lg text-sm text-sidebar-foreground/60 hover:bg-sidebar-accent hover:text-sidebar-foreground transition-colors">
