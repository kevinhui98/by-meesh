  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b border-border">
        <div className="max-w-2xl mx-auto px-6 h-20 grid grid-cols-3 items-center">
          ...
          <div className="flex justify-center">
            <Link href="/">
              <img src="/Logo_3.svg" alt="By Meesh" className="h-12 w-auto cursor-pointer" />
            </Link>
          </div>
          <div />
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <select
                {...register("eventType")}
                className="w-full appearance-none px-3.5 pr-10 py-2.5 bg-background border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ring transition-shadow"
              >
